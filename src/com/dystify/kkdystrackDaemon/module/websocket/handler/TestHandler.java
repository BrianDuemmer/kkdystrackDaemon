package com.dystify.kkdystrackDaemon.module.websocket.handler;

import com.dystify.kkdystrackDaemon.module.websocket.pojo.TestPojo;
...
public class TestHandler extends StompSessionHandlerAdapter {
  ...
  public void afterConnected(StompSession session, StompHeaders headers) {
    ...
    session.send("/app/data", "{\"name\":\"Client\"}".getBytes());
